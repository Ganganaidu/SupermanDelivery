package com.supermandelivery.LocationService;
...
// If the initial location was never previously requested, we use
    ...
    String addressLine = "", addressLine1 = "", addressLine2 = "", completeAddress = "";
    ...
    public String getAddressLine(Context context) {
        ...
        if (addresses != null && addresses.size() > 0) {
            ...
            addressLine2 = address.getAddressLine(2);
            completeAddress = addressLine + ", " + addressLine1 + ", " + addressLine2;
